...
describe("Core permissions test", function () {
  describe.only("Validate Core User permissions against shop/updateShopExternalServices", function () {
    ...
    it("Calling shop/updateShopExternalServices should return 403", function () {
